...
## Running it
Simply invoke _wfdrops_ from command line (for now the python script will scan a copy of the PC Drops). Just needs _python3_,  _python3-tk_ and _python3-matplotlib_ (i.e. `sudo apt install python3 python3-tk python3-matplotlib` on Ubuntu or `sudo pacman -S tk python-lxml` on Manjaro).
